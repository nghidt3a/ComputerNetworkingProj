...
const Logger = {
  ...
  info(message) {
    console.log(
      `%c${this.CLIENT_PREFIX} ${this.INFO} ${message}`,
      this.styles.info
    );
  },
  ...
  success(message) {
    console.log(
      `%c${this.CLIENT_PREFIX} ${this.SUCCESS} ${message}`,
      this.styles.success
    );
  },
  ...
  error(message) {
    console.log(
      `%c${this.CLIENT_PREFIX} ${this.ERROR} ${message}`,
      this.styles.error
    );
  },
  ...
  warning(message) {
    console.log(
      `%c${this.CLIENT_PREFIX} ${this.WARNING} ${message}`,
      this.styles.warning
    );
  },
  ...
  serverAction(message) {
    console.log(
      `%c${this.SERVER_PREFIX} ${this.ARROW} ${message}`,
  ...
  command(command, param = "") {
    ...
    console.log(
      `%c${this.CLIENT_PREFIX} ${this.COMMAND} [CMD] ${command}${paramStr}`,
      this.styles.command
    );
  },
  ...
  file(operation, path) {
    console.log(
      `%c${this.CLIENT_PREFIX} ${this.FILE} ${operation}: ${path}`,
      this.styles.file
    );
  },
  ...
  media(operation, details = "") {
    ...
    console.log(
      `%c${this.CLIENT_PREFIX} ${this.MEDIA} ${operation}${detailsStr}`,
      this.styles.media
    );
  },
  ...
  network(message) {
    console.log(
      `%c${this.CLIENT_PREFIX} ${this.NETWORK} ${message}`,
      this.styles.network
    );
  },
  ...
  ui(action, details = "") {
    const detailsStr = details ? `: ${details}` : "";
    console.log(
      `%c${this.CLIENT_PREFIX} 🎨 [UI] ${action}${detailsStr}`,
  ...
  navigation(tab) {
    console.log(
      `%c${this.CLIENT_PREFIX} 🗺️  Navigation: ${tab}`,
  ...
  debug(message, data = null) {
    if (window.DEBUG_MODE) {
      console.log(
        `%c${this.CLIENT_PREFIX} 🐛 [DEBUG] ${message}`,
        "color: #9E9E9E;"
      );
