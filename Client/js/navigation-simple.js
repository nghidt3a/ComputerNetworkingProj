...
function handleTabChange(targetId, clickedBtn) {
    ...
    console.log("Active button:", document.querySelector('[data-tab].active')?.getAttribute('data-tab'));
...
window.debugNavigation = function() {
    ...
    tabs.forEach((tab, i) => {
        ...
        console.log(`  ${i + 1}. ${tab.id} - Active: ${tab.classList.contains('active')}, Display: ${display}`);
    });
    
    console.log("\nCurrent Active:");
    console.log("  Button:", document.querySelector('[data-tab].active')?.getAttribute('data-tab') || 'None');
    console.log("  Tab:", document.querySelector('.tab-content.active')?.id || 'None');
